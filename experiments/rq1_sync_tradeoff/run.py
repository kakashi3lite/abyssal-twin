...
def generate_figure(results: dict, output_path: Path) -> None:
    ...
    for j, (loss_rate, color, ls) in enumerate(zip(loss_rates, colors, linestyles)):
    ...
    # Annotation
    fig.text(0.5, -0.02,
             "Figure 1: RQ1 Results — DT sync rate vs. anomaly detection under acoustic constraints.\n"
             "All results Stonefish-simulated with injected thruster faults (30% efficiency loss).",
